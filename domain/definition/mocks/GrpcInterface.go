...
func (_m *GrpcInterface) DoGetDetailMovie(ctx context.Context, req *service.GetDetailMovieReq) (*service.GetDetailMovieResp, error) {
...
func (_m *GrpcInterface) DoGetListMovie(ctx context.Context, req *service.GetListMovieReq) (*service.GetListMovieResp, error) {
	ret := _m.Called(ctx, req)
