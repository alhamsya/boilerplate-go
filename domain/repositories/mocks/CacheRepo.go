...
// NewCacheRepo creates a new instance of CacheRepo. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCacheRepo(t testing.TB) *CacheRepo {
	mock := &CacheRepo{}
	mock.Mock.Test(t)
