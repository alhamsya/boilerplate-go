...
// NewOMDBRepo creates a new instance of OMDBRepo. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewOMDBRepo(t testing.TB) *OMDBRepo {
	mock := &OMDBRepo{}
	mock.Mock.Test(t)
