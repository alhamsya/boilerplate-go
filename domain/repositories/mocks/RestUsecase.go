...
// NewRestUsecase creates a new instance of RestUsecase. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewRestUsecase(t testing.TB) *RestUsecase {
	mock := &RestUsecase{}
	mock.Mock.Test(t)
