...
// NewGrpcUsecase creates a new instance of GrpcUsecase. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewGrpcUsecase(t testing.TB) *GrpcUsecase {
	mock := &GrpcUsecase{}
	mock.Mock.Test(t)
