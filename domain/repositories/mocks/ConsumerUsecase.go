...
// NewConsumerUsecase creates a new instance of ConsumerUsecase. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewConsumerUsecase(t testing.TB) *ConsumerUsecase {
